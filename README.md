...
1.  **FHIR ETL (`1 FHIR ETL.ipynb`):** A parallelized ETL pipeline that parses 100k+ raw FHIR JSON bundles. It extracts relevant clinical and demographic data, enriches records with financial information, and loads the clean data into a **DuckDB** database.
