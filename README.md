...
The project has been refactored from an initial exploratory notebook environment into a reproducible, script-based, and containerized application ready for deployment.

## Project Status & Workflow

The project is organized into two main components: a batch pipeline for model training and a real-time API for serving predictions.
...
You can now get real-time predictions.
  ...
  * **Interactive Docs (Recommended):** Open your web browser and navigate to **[http://127.0.0.1:8000/docs](https://www.google.com/search?q=http://127.0.0.1:8000/docs)**.  This interface allows you to test the endpoint directly.
...
│   ├── predict.py         # NEW: Real-time prediction logic
│   ├── train.py
│   └── utils.py
├── .dockerignore
├── .gitignore
